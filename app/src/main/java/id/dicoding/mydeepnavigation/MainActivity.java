...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.btn_open_detail){
            ...
            detailIntent.putExtra("title", getString(R.string.detail_title));
            detailIntent.putExtra("message", getString(R.string.detail_message));
    ...
    private void showNotification(Context context, String title, String message, int notifId){
        ...
        notifDetailIntent.putExtra("title", title);
        notifDetailIntent.putExtra("message", message);
